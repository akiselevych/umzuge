  ...
  return (
    <div className={styles.column}>
      <Materials
        ...
        setValueContract={setValue}
      />

      {/* delivery date */}
      <div
        className={classNames(styles.group, errors.contract?.date && styles.error)}
      >
        <input
      ...
      <>
        <div className={styles.group}>
          <div
            onClick={!isExternalItems ? () => setTimeEnterOpened("start") : undefined}
